...
<div class="mb-8">
    ...
    <p class="text-gray-500 mt-2">
        Kumpulan karya pantun & quotes mahasiswa.
    </p>
</div>
...
<div class="bg-white rounded-3xl p-6 shadow-sm mb-8">
    <div class="flex flex-wrap gap-3">
        ...
        <a href="{{ route('publikasi.pantunquotes') }}" class="kategori-btn active">Pantun & Quotes</a>
    </div>
</div>
...
<div class="bg-white rounded-2xl p-8 text-center shadow-sm">
    ...
    <p class="text-gray-500 mt-2">
        Belum ada karya pantun & quotes yang dipublikasikan.
    </p>
</div>
